...
namespace POS.Web.Migrations
{
    ...
    [Migration("20230111070515_TestMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.DataContext.Customers", b =>
                {
            ...
            modelBuilder.Entity("POS.DataContext.Employees", b =>
                {
            ...
            modelBuilder.Entity("POS.DataContext.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("POS.DataContext.Orders", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("POS.DataContext.Products", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("POS.DataContext.Suppliers", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("POS.DataContext.OrderDetails", b =>
                {
                    b.HasOne("POS.DataContext.Orders", "Order")
                        .WithMany("OrderDetail")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("POS.DataContext.Products", "Product")
                        .WithMany("OrderDetail")
            ...
            modelBuilder.Entity("POS.DataContext.Orders", b =>
                {
                    b.HasOne("POS.DataContext.Customers", "Customer")
                        .WithMany("Order")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("POS.DataContext.Employees", "Employee")
                        .WithMany("Order")
            ...
            modelBuilder.Entity("POS.DataContext.Products", b =>
                {
                    b.HasOne("POS.DataContext.Categories", "Categoroy")
                        .WithMany("Product")
                        .HasForeignKey("CategoroyCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("POS.DataContext.Suppliers", "Supplier")
                        .WithMany("Product")
